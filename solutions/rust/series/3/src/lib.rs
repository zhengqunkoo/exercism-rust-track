...
Return a vector containing as many empty strings as the length of the string "digits" plus one. (this has some nice mathematical properties!) // the AI implementation does this.
 */